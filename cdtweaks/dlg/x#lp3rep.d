...
+ ~InParty("garrick")~ + @3 EXTERN ~X#LP3REP~ X#Troubador3OwnBard
+ ~!InParty("garrick") InParty("eldoth")~ + @3 EXTERN ~X#LP3REP~ X#Troubador3OwnBard
+ ~!InParty("garrick") !InParty("eldoth") InParty("will")~ + @3 EXTERN ~X#LP3REP~ X#Troubador3OwnBard
+ ~!InParty("garrick") !InParty("eldoth") !InParty("will") InParty("devotil")~ + @3 EXTERN ~X#LP3REP~ X#Troubador3OwnBard
...
== ~X#LP3REP~ IF ~InParty("garrick") See("garrick") !StateCheck("garrick",CD_STATE_NOTVALID) Global("X#GarrickRep","GLOBAL",2)~ THEN @35  DO ~IncrementGlobal("X#GarrickRep","GLOBAL",1)~
...
IF ~Class(Player1,PALADIN)~ THEN REPLY @98 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP3RepTalk","GLOBAL",1)~ EXIT
IF ~Class(Player1,THIEF)~ THEN REPLY @99 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP3RepTalk","GLOBAL",1)~ EXIT
...
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB19.1
SAY @118
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB18.1
SAY @119
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB17.1
SAY @120
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) ReputationInc(-1)~ + X#Troubador3Final
END
...
SAY @122
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(399)~ + @117 DO ~TakePartyGold(400) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB14.1
SAY @123
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(199)~ + @117 DO ~TakePartyGold(200) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB13.1
SAY @124
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(299)~ + @117 DO ~TakePartyGold(300) ReputationInc(-1)~ + X#Troubador3Final
END
...
SAY @127
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB9.1
SAY @128
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-1)~ + X#Troubador3Final
END
...
SAY @131
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB5.1
SAY @132
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB4.1
SAY @133
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(4999)~ + @117 DO ~TakePartyGold(5000) ReputationInc(-1)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB20.2
SAY @134
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2399)~ + @117 DO ~TakePartyGold(2400) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB19.2
SAY @135
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1899)~ + @117 DO ~TakePartyGold(1900) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB18.2
SAY @136
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1299)~ + @117 DO ~TakePartyGold(1300) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB17.2
SAY @137
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB16.2
SAY @138
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB15.2
SAY @139
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB14.2
SAY @140
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(449)~ + @117 DO ~TakePartyGold(450) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB13.2
SAY @141
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(599)~ + @117 DO ~TakePartyGold(600) ReputationInc(-2)~ + X#Troubador3Final
END
...
SAY @143
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB10.2
SAY @144
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1399)~ + @117 DO ~TakePartyGold(1400) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB9.2
SAY @145
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1799)~ + @117 DO ~TakePartyGold(1800) ReputationInc(-2)~ + X#Troubador3Final
END
...
SAY @147
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2999)~ + @117 DO ~TakePartyGold(3000) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB6.2
SAY @148
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB5.2
SAY @149
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(6499)~ + @117 DO ~TakePartyGold(6500) ReputationInc(-2)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB20.3
SAY @150
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2799)~ + @117 DO ~TakePartyGold(2800) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB19.3
SAY @132
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB18.3
SAY @131
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB17.3
SAY @151
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB16.3
SAY @138
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB15.3
SAY @152
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) ReputationInc(-3)~ + X#Troubador3Final
END
...
SAY @154
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB12.3
SAY @155
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB11.3
SAY @156
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(1599)~ + @117 DO ~TakePartyGold(1600) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB10.3
SAY @157
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(2199)~ + @117 DO ~TakePartyGold(2200) ReputationInc(-3)~ + X#Troubador3Final
END
...
SAY @159
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(3699)~ + @117 DO ~TakePartyGold(3700) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB7.3
SAY @160
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) ReputationInc(-3)~ + X#Troubador3Final
END

IF ~~ THEN X#T3MB6.3
SAY @161
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) ReputationInc(-3)~ + X#Troubador3Final
END
...
SAY @163
++ @116 + X#Troubador3NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) ReputationInc(-2)~ + X#Troubador3Final
END
