...
IF ~~ THEN BEGIN dmww_fai
  SAY @dmwwresponse
  IF ~~ THEN DO ~ActionOverride("z!deathvariabl2",Formation("z!deathvariable",[3.3]))
  RunAwayFromNoInterrupt([PC],120)
  Face(0) ActionOverride("z!deathvariabl2",Face(0))
  MoveGlobal("AR2301","z!deathvariabl2",dmwwfailo2)
  MoveGlobal("AR2301","z!deathvariable",dmwwfailoc)~
EXIT
END
...
IF
  ...
  RunAwayFromNoInterrupt([PC],120)
  Face(0) ActionOverride("z!deathvariabl2",Face(0))
  MoveGlobal("AR3304","z!deathvariabl2",dmwwberelo2)
  MoveGlobal("AR3304","z!deathvariable",dmwwbereloc)~
EXIT
END
...
IF
  ...
  RunAwayFromNoInterrupt([PC],120)
  Face(0) ActionOverride("z!deathvariabl2",Face(0))
  MoveGlobal("AR4801","z!deathvariabl2",dmwwnashlo2)
  MoveGlobal("AR4801","z!deathvariable",dmwwnashloc)~
EXIT
END
...
IF
  ...
  RunAwayFromNoInterrupt([PC],120)
  Face(0) ActionOverride("z!deathvariabl2",Face(0))
  MoveGlobal("AR0705","z!deathvariabl2",dmwwelflo2)
  MoveGlobal("AR0705","z!deathvariable",dmwwelfloc)~
EXIT
END
