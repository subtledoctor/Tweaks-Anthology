...
+ ~InParty("garrick")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") InParty("eldoth")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") !InParty("eldoth") InParty("will")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") !InParty("eldoth") !InParty("will") InParty("devotil")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
...
IF ~NumTimesTalkedToGT(0) Global("X#LakeP2RepTalk","GLOBAL",1)~ THEN X#Troubador2Again
SAY @6
++ @7 DO ~IncrementGlobal("X#UseTroubadorRep","GLOBAL",1)~ + X#Troubador2OfferInterested
++ @8 + X#Troubador2OfferDeclined
+ ~InParty("garrick")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") InParty("eldoth")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") !InParty("eldoth") InParty("will")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
+ ~!InParty("garrick") !InParty("eldoth") !InParty("will") InParty("devotil")~ + @3 EXTERN ~X#LP2REP~ X#Troubador2OwnBard
...
IF ~NumTimesTalkedToGT(0) Global("X#LakeP2RepTalk","GLOBAL",0)~ THEN X#Troubador2TryAgain
SAY @9
++ @10 + X#Troubador2OfferInterested
++ @8 + X#Troubador2OfferDeclined
END
...
/* Hear me out */
CHAIN ~X#LP2REP~ X#Troubador2OfferHearMeOut
@11
END
++ @12 EXTERN ~X#LP2REP~ X#Troubador2OfferInterested
++ @13 EXTERN ~X#LP2REP~ X#Troubador2OfferDeclined

/* We've got our own bard */
CHAIN ~X#LP2REP~ X#Troubador2OwnBard
@14
END
++ @12 EXTERN ~X#LP2REP~ X#Troubador2OfferInterested
++ @15 EXTERN ~X#LP2REP~ X#Troubador2OfferDeclined

/* Sales pitch - NPCs interject here and meeting globals get set here */
CHAIN ~X#LP2REP~ X#Troubador2OfferInterested
...
== ~X#LP2REP~ IF ~InParty("garrick") See("garrick") !StateCheck("garrick",CD_STATE_NOTVALID) Global("X#GarrickRep","GLOBAL",2)~ THEN @35  DO ~IncrementGlobal("X#GarrickRep","GLOBAL",1)~ 
...
IF ~ReputationGT(Player1,10)~ THEN REPLY @96 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1)~ EXTERN ~X#LP2REP~ X#Troubador2WhyBadGood
IF ~ReputationLT(Player1,11)~ THEN REPLY @96 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1)~ EXTERN ~X#LP2REP~ X#Troubador2WhyBadEvil
IF ~~ THEN REPLY @97  DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1) IncrementGlobal("X#UseTroubadorRep","GLOBAL",1)~ EXTERN ~X#LP2REP~ X#Troubador2MakeBad
IF ~Class(Player1,PALADIN)~ THEN REPLY @98 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1)~ EXIT
IF ~Class(Player1,THIEF)~ THEN REPLY @99 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1) SetGlobal("X#LakeP2RepTalk","GLOBAL",1)~ EXIT
IF ~Global("X#TroubadorRep","GLOBAL",1) Global("X#LakeP2RepTalk","GLOBAL",0)~ THEN REPLY @100 EXTERN ~X#LP2REP~ X#Troubador2RepAlready

APPEND ~X#LP2REP~
/* met a different troubador */
IF ~~ THEN X#Troubador2RepAlready
SAY @101
++ @102 DO ~IncrementGlobal("X#UseTroubadorRep","GLOBAL",1)~ + X#Troubador2OfferInterested
++ @8 + X#Troubador2OfferDeclined
END

/* No, thanks */
IF ~~ X#Troubador2OfferDeclined
SAY @103
IF ~~ THEN EXIT
END
...
CHAIN ~X#LP2REP~ X#Troubador2WhyBadGood
@104
== ~JAHEIJ~ IF ~InParty("jaheira") See("jaheira") !StateCheck("jaheira",CD_STATE_NOTVALID)~ THEN @105
END
IF ~~ THEN REPLY @97 DO ~SetGlobal("X#TroubadorRep","GLOBAL",1)~ EXTERN ~X#LP2REP~ X#Troubador2MakeBad
IF ~~ THEN REPLY @106 EXTERN ~X#LP2REP~ X#Troubador2OfferDeclined

CHAIN ~X#LP2REP~ X#Troubador2WhyBadEvil
@107
== ~VICONJ~ IF ~InParty("viconia") See("viconia") !StateCheck("viconia",CD_STATE_NOTVALID)~ THEN @108
END
IF ~~ THEN REPLY @109 DO ~IncrementGlobal("X#UseTroubadorRep","GLOBAL",1)~ EXTERN ~X#LP2REP~ X#Troubador2MakeBad
IF ~~ THEN REPLY @106 EXTERN ~X#LP2REP~ X#Troubador2OfferDeclined

/* the deal is done */
APPEND ~X#LP2REP~
IF ~~ THEN X#Troubador2MakeBad
SAY @110
+ ~Reputation(Player1,20)~ + @111 + X#T2MB20.1
+ ~Reputation(Player1,19)~ + @112 + X#T2MB19.1
+ ~Reputation(Player1,18)~ + @112 + X#T2MB18.1
+ ~Reputation(Player1,17)~ + @112 + X#T2MB17.1
+ ~Reputation(Player1,16)~ + @112 + X#T2MB16.1
+ ~Reputation(Player1,15)~ + @112 + X#T2MB15.1
+ ~Reputation(Player1,14)~ + @112 + X#T2MB14.1
+ ~Reputation(Player1,13)~ + @112 + X#T2MB13.1
+ ~Reputation(Player1,12)~ + @112 + X#T2MB12.1
+ ~Reputation(Player1,11)~ + @112 + X#T2MB11.1
+ ~Reputation(Player1,10)~ + @112 + X#T2MB10.1
+ ~Reputation(Player1,9)~ + @112 + X#T2MB9.1
+ ~Reputation(Player1,8)~ + @112 + X#T2MB8.1
+ ~Reputation(Player1,7)~ + @112 + X#T2MB7.1
+ ~Reputation(Player1,6)~ + @112 + X#T2MB6.1
+ ~Reputation(Player1,5)~ + @112 + X#T2MB5.1
+ ~Reputation(Player1,4)~ + @112 + X#T2MB4.1
+ ~ReputationLT(Player1,4)~ + @112 + X#T2MBNotPossible
+ ~Reputation(Player1,20)~ + @113 + X#T2MB20.2
+ ~Reputation(Player1,19)~ + @113 + X#T2MB19.2
+ ~Reputation(Player1,18)~ + @113 + X#T2MB18.2
+ ~Reputation(Player1,17)~ + @113 + X#T2MB17.2
+ ~Reputation(Player1,16)~ + @113 + X#T2MB16.2
+ ~Reputation(Player1,15)~ + @113 + X#T2MB15.2
+ ~Reputation(Player1,14)~ + @113 + X#T2MB14.2
+ ~Reputation(Player1,13)~ + @113 + X#T2MB13.2
+ ~Reputation(Player1,12)~ + @113 + X#T2MB12.2
+ ~Reputation(Player1,11)~ + @113 + X#T2MB11.2
+ ~Reputation(Player1,10)~ + @113 + X#T2MB10.2
+ ~Reputation(Player1,9)~ + @113 + X#T2MB9.2
+ ~Reputation(Player1,8)~ + @113 + X#T2MB8.2
+ ~Reputation(Player1,7)~ + @113 + X#T2MB7.2
+ ~Reputation(Player1,6)~ + @113 + X#T2MB6.2
+ ~Reputation(Player1,5)~ + @113 + X#T2MB5.2
+ ~Reputation(Player1,4)~ + @113 + X#T2MBALittle
+ ~ReputationLT(Player1,4)~ + @113 + X#T2MBNotPossible
+ ~Reputation(Player1,20)~ + @114 + X#T2MB20.3
+ ~Reputation(Player1,19)~ + @114 + X#T2MB19.3
+ ~Reputation(Player1,18)~ + @114 + X#T2MB18.3
+ ~Reputation(Player1,17)~ + @114 + X#T2MB17.3
+ ~Reputation(Player1,16)~ + @114 + X#T2MB16.3
+ ~Reputation(Player1,15)~ + @114 + X#T2MB15.3
+ ~Reputation(Player1,14)~ + @114 + X#T2MB14.3
+ ~Reputation(Player1,13)~ + @114 + X#T2MB13.3
+ ~Reputation(Player1,12)~ + @114 + X#T2MB12.3
+ ~Reputation(Player1,11)~ + @114 + X#T2MB11.3
+ ~Reputation(Player1,10)~ + @114 + X#T2MB10.3
+ ~Reputation(Player1,9)~ + @114 + X#T2MB9.3
+ ~Reputation(Player1,8)~ + @114 + X#T2MB8.3
+ ~Reputation(Player1,7)~ + @114 + X#T2MB7.3
+ ~Reputation(Player1,6)~ + @114 + X#T2MB6.3
+ ~Reputation(Player1,5)~ + @114 + X#T2MBModerate
+ ~Reputation(Player1,4)~ + @114 + X#T2MBALittle
+ ~ReputationLT(Player1,4)~ + @114 + X#T2MBNotPossible
END

IF ~~ THEN X#T2MB20.1
SAY @115 // removed all DestroyGold()
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.1
SAY @118
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.1
SAY @119
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.1
SAY @120
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @122
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(399)~ + @117 DO ~TakePartyGold(400) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB14.1
SAY @123
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(199)~ + @117 DO ~TakePartyGold(200) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB13.1
SAY @124
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(299)~ + @117 DO ~TakePartyGold(300) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @127
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.1
SAY @128
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-1)~ + X#Troubador2Final
END
...
SAY @131
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB5.1
SAY @132
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB4.1
SAY @133
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(4999)~ + @117 DO ~TakePartyGold(5000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB20.2
SAY @134
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2399)~ + @117 DO ~TakePartyGold(2400) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.2
SAY @135
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1899)~ + @117 DO ~TakePartyGold(1900) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.2
SAY @136
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1299)~ + @117 DO ~TakePartyGold(1300) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.2
SAY @137
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB16.2
SAY @138
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB15.2
SAY @139
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(499)~ + @117 DO ~TakePartyGold(500) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB14.2
SAY @140
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(449)~ + @117 DO ~TakePartyGold(450) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB13.2
SAY @141
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(599)~ + @117 DO ~TakePartyGold(600) ReputationInc(-2)~ + X#Troubador2Final
END
...
SAY @143
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(999)~ + @117 DO ~TakePartyGold(1000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB10.2
SAY @144
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1399)~ + @117 DO ~TakePartyGold(1400) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.2
SAY @145
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1799)~ + @117 DO ~TakePartyGold(1800) ReputationInc(-2)~ + X#Troubador2Final
END
...
SAY @147
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2999)~ + @117 DO ~TakePartyGold(3000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB6.2
SAY @148
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB5.2
SAY @149
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(6499)~ + @117 DO ~TakePartyGold(6500) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB20.3
SAY @150
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2999)~ + @117 DO ~TakePartyGold(2800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB19.3
SAY @132
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2499)~ + @117 DO ~TakePartyGold(2500) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB18.3
SAY @131
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1999)~ + @117 DO ~TakePartyGold(2000) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB17.3
SAY @151
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1499)~ + @117 DO ~TakePartyGold(1500) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB16.3
SAY @138
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(799)~ + @117 DO ~TakePartyGold(800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB15.3
SAY @152
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(699)~ + @117 DO ~TakePartyGold(700) ReputationInc(-3)~ + X#Troubador2Final
END
...
SAY @154
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(899)~ + @117 DO ~TakePartyGold(900) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB12.3
SAY @155
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1199)~ + @117 DO ~TakePartyGold(1200) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB11.3
SAY @156
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(1599)~ + @117 DO ~TakePartyGold(1600) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB10.3
SAY @157
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2199)~ + @117 DO ~TakePartyGold(2200) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB9.3
SAY @158
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(2799)~ + @117 DO ~TakePartyGold(2800) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB8.3
SAY @159
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3699)~ + @117 DO ~TakePartyGold(3700) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB7.3
SAY @160
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(3999)~ + @117 DO ~TakePartyGold(4000) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MB6.3
SAY @161
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) ReputationInc(-3)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MBALittle
SAY @162
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(4999)~ + @117 DO ~TakePartyGold(5000) ReputationInc(-1)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MBModerate
SAY @163
++ @116 + X#Troubador2NoCoin
+ ~PartyGoldGT(7499)~ + @117 DO ~TakePartyGold(7500) ReputationInc(-2)~ + X#Troubador2Final
END

IF ~~ THEN X#T2MBNotPossible
SAY @164
IF ~~ THEN EXIT
END

IF ~~ THEN X#Troubador2NoCoin
SAY @165
IF ~~ THEN EXIT
END

IF ~~ THEN X#Troubador2Final
SAY @166
IF ~~ THEN DO ~SetGlobal("X#TT2Deactivate","GLOBAL",1)~ EXIT
END
